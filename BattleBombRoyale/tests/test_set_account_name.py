...
from BattleBombRoyale.account.account import *
...
class TestBattleBombRoyale(IconIntegrateTestBase):
    ...
    # ===============================================================
    def test_set_account_name_ok(self):
        # OK
        ...
        result = transaction_call_success(super(), 
            ...
            to_=self._score_address, 
            method="set_account_name",
            params={'name': 'a'*Account._NAME_MIN_CHARACTERS},
            icon_service=self.icon_service
        )
        ...
        result = transaction_call_success(super(), 
            ...
            to_=self._score_address, 
            method="set_account_name",
            params={'name': 'a'*Account._NAME_MAX_CHARACTERS},
            icon_service=self.icon_service
        )

    # ===============================================================
    def test_set_account_name_INVALID_ACCOUNT_NAME(self):
        # Error
        ...
        self.assertEqual(result['failure']['message'], 'INVALID_ACCOUNT_NAME')
        ...
        result = transaction_call_error(super(), 
            ...
            to_=self._score_address, 
            method="set_account_name",
            params={'name': 'a'*(Account._NAME_MIN_CHARACTERS-1)},
            icon_service=self.icon_service
        )
        self.assertEqual(result['failure']['message'], 'INVALID_ACCOUNT_NAME')
        ...
        result = transaction_call_error(super(), 
            ...
            to_=self._score_address, 
            method="set_account_name",
            params={'name': 'a'*(Account._NAME_MAX_CHARACTERS+1)},
            icon_service=self.icon_service
        )
        self.assertEqual(result['failure']['message'], 'INVALID_ACCOUNT_NAME')

    def test_set_account_name_METHOD_NOT_PAYABLE (self):
        # Fail
        result = transaction_call_error(super(), 
            from_=self._j1, 
            to_=self._score_address, 
