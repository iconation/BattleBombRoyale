...
class TestBattleBombRoyale(IconIntegrateTestBase):
    ...
    def test_join_game_INVALID_PARTICIPATION_COST(self):
        # Fail
        ...
        self.assertEqual(result['failure']['message'], 'INVALID_PARTICIPATION_COST')
    ...
    def test_join_game_PLAYER_ALREADY_REGISTERED(self):
        # OK
        result = transaction_call_success(super(), 
            from_=self._j2, 
            to_=self._score_address, 
    ...
    def test_join_game_GAME_DOESNT_EXIST(self):
        # Fail
        result = transaction_call_error(super(), 
            from_=self._j2, 
            to_=self._score_address, 
        ...
        self.assertEqual(result['failure']['message'], 'GAME_DOESNT_EXIST')

    def test_join_game_GAME_ALREADY_STARTED(self):
        # OK
        result = transaction_call_success(super(), 
            from_=self._j2, 
            to_=self._score_address, 
    ...
    def test_join_game_GAME_ALREADY_STARTED_after_quit(self):
        # OK
        result = transaction_call_success(super(), 
            from_=self._j2, 
            to_=self._score_address, 
    ...
    def test_join_game_GAME_ALREADY_STARTED_after_quit_multiplayer(self):
        # OK
        result = transaction_call_success(super(), 
            from_=self._j2, 
            to_=self._score_address, 
