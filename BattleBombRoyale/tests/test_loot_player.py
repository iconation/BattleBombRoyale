...
class TestBattleBombRoyale(IconIntegrateTestBase):
    ...
    # ===============================================================
    def test_loot_player_from_alive_ok(self):
        self.set_ready()
        self.start_game()
    ...
    def test_loot_player_from_dead_ok(self):
        self.set_ready()
        self.start_game()
        looted = self._has_bomb_wallet
        self.wait_and_loot()
        self.refresh_state()
        self.wait()
    ...
    def test_loot_player_spectator_not_ok(self):
        self.set_ready()
        self.start_game()
        self.wait()
        # Fail
        result = transaction_call_error(super(), 
            from_=self._spectator, 
            to_=self._score_address, 
            method="loot_player", 
            icon_service=self.icon_service,
            params={'looted_address' : self._has_bomb.address}
    ...
    # ===============================================================
    def test_loot_player_METHOD_NOT_PAYABLE(self):
        self.set_ready()
        self.start_game()
        self.wait()
        # Fail
    ...
    def test_loot_player_PLAYER_NOT_FOUND(self):
        self.set_ready()
        self.start_game()
        self.wait()
        # Fail
        result = transaction_call_error(super(), 
            ...
            to_=self._score_address, 
            method="loot_player", 
            params={'looted_address' : self._spectator.get_address()},
            icon_service=self.icon_service
        )
        self.assertEqual(result['failure']['message'], 'PLAYER_NOT_FOUND')

    def test_loot_player_DO_NOT_SUICIDE(self):
        self.set_ready()
        self.start_game()
        self.wait()
        # Fail
        result = transaction_call_error(super(), 
            ...
            to_=self._score_address, 
            method="loot_player", 
            params={'looted_address' : self._players_no_bomb[0].address},
            icon_service=self.icon_service
        )
        self.assertEqual(result['failure']['message'], 'DO_NOT_SUICIDE')
    ...
    def test_loot_player_PLAYER_IS_NOT_LOOTABLE_when_no_bomb(self):
        self.set_ready()
        self.start_game()
        self.wait()
        ...
        result = transaction_call_error(super(), 
            ...
            to_=self._score_address, 
            method="loot_player", 
            params={'looted_address' : self._players_no_bomb[1].address},
            icon_service=self.icon_service
        )
        self.assertEqual(result['failure']['message'], 'PLAYER_IS_NOT_LOOTABLE')

    def test_loot_player_PLAYER_IS_NOT_LOOTABLE_when_alive(self):
        self.set_ready()
        self.start_game()
        # Fail
        result = transaction_call_error(super(), 
    ...
    def test_loot_player_PLAYER_IS_NOT_LOOTABLE_when_dead(self):
        self.set_ready()
        self.start_game()
        self.wait()
        self.loot()
    ...
    def test_loot_player_GAME_NOT_STARTED(self):
        self.wait()
        ...
        result = transaction_call_error(super(), 
            ...
            method="loot_player", 
            icon_service=self.icon_service,
            params={'looted_address' : self._j2.address}
        )
