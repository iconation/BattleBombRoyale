...
class TestBattleBombRoyale(IconIntegrateTestBase):
    ...
    def test_ready_ask_PLAYER_IS_NOT_REGISTERED (self):
        # Fail
    ...
    def test_ready_ask_GAME_ALREADY_STARTED (self):
        # OK
        result = transaction_call_success(super(), 
            from_=self._j1, 
            to_=self._score_address, 
    ...
    def test_ready_ask_NOT_ENOUGH_PLAYERS (self):
        # OK
        result = transaction_call_success(super(), 
            from_=self._j2, 
            to_=self._score_address, 
        ...
        self.assertEqual(result['failure']['message'], 'NOT_ENOUGH_PLAYERS')

    def test_ready_ask_READY_COUNTDOWN_ALREADY_STARTED (self):
        # OK
        result = transaction_call_success(super(), 
            from_=self._j1, 
            to_=self._score_address, 
        ...
        self.assertEqual(result['failure']['message'], 'READY_COUNTDOWN_ALREADY_STARTED')

    def test_ready_ask_INVALID_GAME_HOST (self):
        # Fail
        result = transaction_call_error(super(), 
            from_=self._j2, 
            to_=self._score_address, 
        ...
        self.assertEqual(result['failure']['message'], 'INVALID_GAME_HOST')
