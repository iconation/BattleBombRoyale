...
class TestBattleBombRoyale(IconIntegrateTestBase):
    ...
    def setUp(self):
        ...
        self._j1_balance = get_icx_balance(super(), address=self._j1.get_address(), icon_service=self.icon_service)
    ...
    def test_quit_game_PLAYER_IS_NOT_REGISTERED (self):
        # Fail
    ...
    def test_quit_game_METHOD_NOT_PAYABLE (self):
        # Fail
        result = transaction_call_error(super(), 
            from_=self._j1, 
            to_=self._score_address, 
    ...
    def test_quit_game_check_refund (self):
        # OK
        result = transaction_call_success(super(), 
            from_=self._j1, 
            to_=self._score_address, 
        ...
        # Check reward
        balance = get_icx_balance(super(), address=self._j1.get_address(), icon_service=self.icon_service)

        # OK
        self.assertEqual(balance, self._j1_balance)

    def test_quit_game_check_game_destroyed (self):
        # OK
        result = transaction_call_success(super(), 
            from_=self._j1, 
            to_=self._score_address, 
        ...
        result = icx_call(super(), 
            from_=self._j2.get_address(), 
            to_=self._score_address, 
            method="get_player_room",
            params={'address': self._j2.get_address()},
            icon_service=self.icon_service,
        )
        ...
        result = icx_call(super(), 
            ...
            to_=self._score_address, 
            method="get_player_room",
            params={'address': self._j1.get_address()},
            icon_service=self.icon_service,
        )
        self.assertEqual(result, "")
        # OK
    ...
    def test_quit_game_check_new_host (self):
        # OK
        result = transaction_call_success(super(), 
            from_=self._j1, 
            to_=self._score_address, 
        ...
        gamestate = GameState.deserialize(result)
        self.assertTrue(gamestate._is_host(Player(self._j2.address)))
    
    def test_quit_game_rejoin_before_start (self):
    ...
    def test_quit_game_rejoin_after_start (self):
        # OK
        result = transaction_call_success(super(), 
            from_=self._j1, 
            to_=self._score_address, 
