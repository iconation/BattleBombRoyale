...
class TestBattleBombRoyale(IconIntegrateTestBase):
    ...
    def test_start_game_not_host_ok (self):
        # OK
        result = transaction_call_success(super(), 
            from_=self._j1, 
            to_=self._score_address, 
    ...
    def test_start_game_PLAYER_IS_NOT_REGISTERED (self):
        # Fail
    ...
    def test_start_game_METHOD_NOT_PAYABLE (self):
        # Fail
        result = transaction_call_error(super(), 
            from_=self._j1, 
            to_=self._score_address, 
    ...
    def test_start_game_NOT_ENOUGH_PLAYERS_when_start (self):
        # OK
        result = transaction_call_success(super(), 
            from_=self._j1, 
            to_=self._score_address, 
    ...
    def test_start_game_READY_COUNTDOWN_NOT_REACHED (self):
        # OK
        result = transaction_call_success(super(), 
            from_=self._j1, 
            to_=self._score_address, 
        ...
        self.assertEqual(result['failure']['message'], 'READY_COUNTDOWN_NOT_REACHED')
